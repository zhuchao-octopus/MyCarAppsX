...
public class Screen1LauncherUI extends UIBase implements View.OnClickListener {
    ...
    public static Screen1LauncherUI getInstanse(Context context, View view, int index) {
    ...
    private static final int[] BUTTON_ON_CLICK = new int[]{
            R.id.button_radio, R.id.button_bluetooth, R.id.button_bluetooth_music, R.id.button_dvd, R.id.button_music, R.id.button_video, R.id.button_bluetooth_auxin
    };
