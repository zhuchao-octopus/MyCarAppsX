    ...
    public MarkFaceView(Context context, AttributeSet attrs) {
        ...
        if (bitmap_point == 1) {
            ...
            if (!MachineConfig.VALUE_SYSTEM_UI31_KLD7.equals(GlobalDef.getSystemUI())) {
                d = context.getResources().getDrawable(R.drawable.freq_point);
            } else {
                d = context.getResources().getDrawable(R.drawable.freq_point2);
            ...
            if (STEP[0] > -1) {
                ...
                for (int i = 0; i < STEP.length - 1; ++i) {
                    if (STEP[i] > -1) {
                        ...
                        canvas.drawText((n / 100) + "." + ((n % 100) / 10), STEP[i], FREQ_Y, mPaint);
                    }
                }

                canvas.drawText((mMaxFmFrequency / 100) + "." + ((mMaxFmFrequency % 100) / 10), STEP[STEP.length - 1], FREQ_Y, mPaint);
            }
        }
