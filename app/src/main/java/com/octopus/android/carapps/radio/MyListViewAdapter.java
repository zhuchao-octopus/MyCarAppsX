...
//		}
		...
		if (MachineConfig.VALUE_SYSTEM_UI_KLD12_80.equals(GlobalDef.getSystemUI())
				|| MachineConfig.VALUE_SYSTEM_UI19_KLD1.equals(GlobalDef.getSystemUI())
				|| MachineConfig.VALUE_SYSTEM_UI28_7451.equals(GlobalDef.getSystemUI())
				|| MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())
				|| MachineConfig.VALUE_SYSTEM_UI43_3300_1.equals(GlobalDef.getSystemUI())) {
			mLineNum = 2;
			mRowNum = 3;
		}
	}
...
//			int total_page = AkRadio.MIN_FREQ_LIST / one_page_num;
			...
			if (index >= mRowNum) {
				...
				if (index < one_line_num) {
					...
					index = row * one_page_num
							+ ((index - one_line_num) - (mRowNum * row))
							+ mRowNum;
				}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.text1 = (TextView) convertView
					.findViewById(R.id.list_text1);
			viewHolder.text2 = (TextView) convertView
					.findViewById(R.id.list_text2);
			viewHolder.text3 = (TextView) convertView
					.findViewById(R.id.list_text3);
			viewHolder.textPS = (TextView) convertView
					.findViewById(R.id.list_ps_name);
		...
		if (mAkRadio != null) {
			...
			if (mPos == position) {
				...
				viewHolder.text1.setTextColor(mActivity.getResources()
						.getColor(R.color.list_normal_colre));
				viewHolder.text2.setTextColor(mActivity.getResources()
						.getColor(R.color.list_normal_colre));
				viewHolder.text3.setTextColor(mActivity.getResources()
						.getColor(R.color.list_normal_colre));
				if (viewHolder.textPS != null) {
					viewHolder.textPS.setTextColor(mActivity.getResources()
							.getColor(R.color.list_normal_colre));
				}
