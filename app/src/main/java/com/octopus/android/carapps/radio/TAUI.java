...
public class TAUI {
	...
	public TAUI(Context c, AkRadio radio) {
		mView = ((LayoutInflater) c
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(
				R.layout.radio_ta_layout, null);
		mAkRadio = radio;
		((ImageView) mView.findViewById(R.id.radio_ta_switch))
...
//						hide();
		...
		mLayoutParams = new WindowManager.LayoutParams(
				...
				LayoutParams.TYPE_PHONE, LayoutParams.FLAG_NOT_TOUCH_MODAL,
