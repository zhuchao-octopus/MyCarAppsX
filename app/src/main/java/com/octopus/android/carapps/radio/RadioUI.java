...
public class RadioUI extends UIBase implements View.OnClickListener {
    ...
    private static final int[] BUTTON_ON_CLICK = new int[]{
            R.id.radio_function_button_scan, R.id.radio_function_button_seek_previous, R.id.radio_function_button_band, R.id.radio_function_button_amfm, R.id.radio_function_button_seek_next,
            R.id.radio_function_button_dx, R.id.eq, R.id.radio_step_up_button, R.id.radio_step_down_button, R.id.radio_function_button_reg, R.id.radio_function_button_af,
            R.id.radio_function_button_ta, R.id.radio_button_loc, R.id.radio_function_button_pty, R.id.radio_keyboard, R.id.btn_prev, R.id.btn_next, R.id.btn_list, R.id.favorit_back,
            R.id.radio_pty_layout, R.id.eq_mode_switch,

            R.id.radio_function_button_seek_previous_and_step, R.id.radio_function_button_seek_next_and_step, R.id.left_gps, R.id.back, R.id.home, R.id.radio_function_button_st,
            R.id.radio_button_loc2, R.id.radio_button_loc3, R.id.layout_set, R.id.bottom_set, R.id.channel_00, R.id.channel_01, R.id.channel_02, R.id.channel_03, R.id.channel_04, R.id.channel_05,
            R.id.channel_06, R.id.channel_07, R.id.channel_08, R.id.channel_09, R.id.channel_10, R.id.channel_11, R.id.channel_12, R.id.channel_13, R.id.channel_14, R.id.channel_15, R.id.channel_16,
            R.id.channel_17, R.id.channel_18, R.id.channel_19, R.id.channel_20, R.id.channel_21, R.id.channel_22, R.id.channel_23, R.id.channel_24, R.id.channel_25, R.id.channel_26, R.id.channel_27,
            R.id.channel_28, R.id.channel_29, R.id.fm_sel, R.id.am_sel,

            R.id.fm_sel2, R.id.am_sel2, R.id.radio_list_next, R.id.radio_list_prev, R.id.btn_band_prev, R.id.btn_band_next, R.id.btn_band_prev2, R.id.btn_band_next2,
            R.id.radio_function_button_ps_search
    };// ,R.id.mic,R.id.vol };
        ...
        if (mDisplayIndex == SCREEN1) {
            ...
            for (int i = 0; i < VIEW_INVISIBLE2.length; ++i) {
                ...
                if (v != null) {
                    ...
                    v.setVisibility(fullFunction ? View.VISIBLE : View.INVISIBLE);
    ...
    private void initPresentationUI() {
        for (int i : BUTTON_ON_CLICK) {
            ...
            if (v != null) {
                if (i >= R.id.channel_00 && i <= R.id.channel_29) {
                    ...
                    if (i == R.id.radio_function_button_seek_previous_and_step || i == R.id.radio_function_button_seek_next_and_step) {
        ...
        if (v != null) {
            ...
            if (MachineConfig.VALUE_SYSTEM_UI22_1050.equals(value) || MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(value)) {
        ...
        if (MachineConfig.VALUE_SYSTEM_UI_KLD11_200.equals(value) || (GlobalDef.mRadioButtonType == GlobalDef.RADIO_BUTTON_TYPE_LONG_PRESS_SCAN)) {

            if (mMainView.findViewById(R.id.radio_function_button_scan) != null) {
                mMainView.findViewById(R.id.radio_function_button_scan).setOnLongClickListener(new OnLongClickListener() {
                    @Override
            ...
            setChanne00Background(R.id.channel_00, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_01, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_02, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_03, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_04, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_05, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_06, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_07, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_08, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_09, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_10, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_11, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_12, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_13, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_14, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_15, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_16, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_17, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_18, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_19, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_20, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_21, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_22, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_23, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_24, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_25, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_26, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_27, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_28, R.drawable.radio_channel_button);
            setChanne00Background(R.id.channel_29, R.drawable.radio_channel_button);
        }

        if (mMainView.findViewById(R.id.radio_function_button_ps_search) != null) {
            mMainView.findViewById(R.id.radio_function_button_ps_search).setOnLongClickListener(new OnLongClickListener() {
                @Override
                public boolean onLongClick(View arg0) {
                    // TODO Auto-generated method stub
                    mAkRadio.sendMRDCommand(AkRadio.MRD_AS);
        ...
        if (mMainView.findViewById(R.id.radio_step_up_button) != null) {
            mMainView.findViewById(R.id.radio_step_up_button).setOnLongClickListener(new OnLongClickListener() {
                @Override
                public boolean onLongClick(View arg0) {
                    // TODO Auto-generated method stub
        ...
        if (mMainView.findViewById(R.id.radio_step_down_button) != null) {
            mMainView.findViewById(R.id.radio_step_down_button).setOnLongClickListener(new OnLongClickListener() {
                @Override
                public boolean onLongClick(View arg0) {
                    // TODO Auto-generated method stub
        ...
        if (mAkRadio == null) {
            ...
            if (mAkRadio != null) {
                ...
                if (mAkRadio.mMRDFreqency == 0) {
                    ...
                    if (i == 0) {
                        mAkRadio.mMRDFreqency = (short) getDataEx(RADIO_SAVE, KEY_FREQ);
                        mAkRadio.mMRDBand = (byte) getDataEx(RADIO_SAVE, KEY_BAUD);
                        if (mAkRadio.mMRDFreqency == 0) {
    ...
    public void onCreate() {
        ...
        mPtyName = (TextView) mMainView.findViewById(R.id.radio_current_pty_type_name);
    ...
    private void init() {
        ...
        mMarkFace = (MarkFaceView) mMainView.findViewById(R.id.radio_mark_face_view);
        if (mMarkFace != null) {
        ...
        if (mListViewFreqs != null) {
            ...
            mListViewFreqs.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (mAkRadio != null) {
                        ...
                        GlobalDef.reactiveSource(mContext, SOURCE, RadioService.mAudioFocusListener);
            ...
            mListViewFreqs.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            mGirdViewFreqs.setOnItemSelectedListener(new OnItemSelectedListener() {
                @Override
                    ...
                    mHandler.post(new Runnable() {
                        public void run() {
                            if (mAkRadio != null) {
                                ...
                                mLongPressSeekButton = false;
                                mAkRadio.sendMRDCommand(AkRadio.MRD_LIST_INDEX, new_pos);
                            }
                        }
                    });
            ...
            mGirdViewFreqs.setOnItemLongClickListener(new OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.radio_function_button_dx) {
            ...
            if (mAkRadio.mMRDBand < AkRadio.MRD_AM || mAkRadio.mMRDBand == AkRadio.MRD_AM2) {
            ...
            String value = GlobalDef.getSystemUI();
            if (!(MachineConfig.VALUE_SYSTEM_UI_KLD11_200.equals(value) || (GlobalDef.mRadioButtonType == GlobalDef.RADIO_BUTTON_TYPE_LONG_PRESS_SCAN)) || ((mAkRadio.mMRDFlag & 0x80) != 0)) {
                mAkRadio.sendMRDCommand(AkRadio.MRD_AS);
                GlobalDef.reactiveSource(mContext, SOURCE, RadioService.mAudioFocusListener);
            }
            ...
            BroadcastUtil.sendToCarService(mContext, MyCmd.Cmd.APP_REQUEST_SEND_KEY, MyCmd.Keycode.NAVIGATION);
    ...
    private void showPtyList(boolean show) {
        ...
        if (v == null) {
            if (!show) {
                mMainView.findViewById(R.id.radio_frequency_list).setVisibility(View.VISIBLE);
                mMainView.findViewById(R.id.radio_pty_list).setVisibility(View.GONE);
                ...
                mMainView.findViewById(R.id.radio_frequency_list).setVisibility(View.GONE);
                mMainView.findViewById(R.id.radio_pty_list).setVisibility(View.VISIBLE);
                // if (mMainView.findViewById(R.id.HorizontalScrollView_pty) !=
                // null) {
                // mMainView.findViewById(R.id.HorizontalScrollView_pty)
            ...
            Button button = (Button) mMainView.findViewById(R.id.radio_function_button_pty);
            if (show) {
                button.setText(mContext.getString(R.string.radio_function_text_pty));
            } else {
                button.setText(mContext.getString(R.string.radio_function_text_frq));
            }
        } else {
    ...
    private void showFavoriteList() {
        if (mGirdViewFavoriteList == null) {
            mGirdViewFavoriteList = (GridView) mMainView.findViewById(R.id.grid_favorite_list);
            mGirdViewFavoriteParent = mMainView.findViewById(R.id.favorite_list);

            if (mGirdViewFavoriteList != null) {
                mGirdViewFavoriteList.setVisibility(View.VISIBLE);

                mFavoriteListAdapter = new MyListViewAdapter(mContext, R.layout.tl_list_radio_favorite);
                ...
                mGirdViewFavoriteList.setOnItemClickListener(new OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (mAkRadio != null) {
                ...
                mGirdViewFavoriteList.setOnItemLongClickListener(new OnItemLongClickListener() {
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void showKeyboard() {
        if (mRadioKeyboardDialog == null) {
            mRadioKeyboardDialog = new RadioKeyboardDialog(mContext, mOnClickRadioKeyboardDialogOk);
        }
    ...
    private View.OnClickListener mOnClickRadioKeyboardDialogOk = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            if (baud >= mAkRadio.mFreqMin && baud <= mAkRadio.mFreqMax) {
                ...
                Toast.makeText(mContext, "Incorrect freq!", Toast.LENGTH_LONG).show();
            }
    ...
    public void processButtonStatus(int id) {
        if (mCurrentButtonId != -1) {
            ToggleButton currentButton = (ToggleButton) mMainView.findViewById(mCurrentButtonId);
            if (currentButton != null && currentButton.isChecked()) currentButton.setChecked(false);
            mCurrentButtonId = -1;
            if (id != -1) {
                ToggleButton my = (ToggleButton) mMainView.findViewById(id);
                if (my != null && my.isChecked()) my.setChecked(false);
            }
        } else {
            mCurrentButtonId = id;
        }
    ...
    private void SetFmFreqTextImage(short freq) {
        if (USE_TEXTVIEW_FREQ) {
            ...
            if (tv != null) {
                ...
                TextView tv_ps = (TextView) mMainView.findViewById(R.id.freq_text_ps);
                ...
                if (mAkRadio.mStrRdsPs != null && mAkRadio.mStrRdsPs.length() > 0) {
                    if (tv_ps != null) {
                        ...
                        View tv_ps2 = mMainView.findViewById(R.id.freq_text_ps2);
                        if (tv_ps2 == null) {
            ...
            a = a % 10;
            mFreqDigitalp2.getBackground().setLevel((int) (((int) (freq)) % 10));
            mFreqDigitalp1.getBackground().setLevel((int) (((int) (freq / 10)) % 10));
            mFreqDigital3.getBackground().setLevel((int) (((int) (freq / 100)) % 10));
            mFreqDigital2.getBackground().setLevel((int) (((int) (freq / 1000)) % 10));
        }
    }
    ...
    private void SetAmFreqTextImage(int freq) {
        if (USE_TEXTVIEW_FREQ) {
            ...
            if (freq >= 1000) {
                mFreqDigital1.setVisibility(View.VISIBLE);
                mFreqDigital1.getBackground().setLevel((int) (((int) (freq / 1000)) % 10));
            } else {
                mFreqDigital1.setVisibility(View.GONE);
            }
            ...
            mFreqDigitalp1.getBackground().setLevel((int) (((int) (freq)) % 10));
            mFreqDigital3.getBackground().setLevel((int) (((int) (freq / 10)) % 10));
            mFreqDigital2.getBackground().setLevel((int) (((int) (freq / 100)) % 10));
        }
    }
    ...
    private void updatePSInfo() {
        ...
        TextView tv = (TextView) mMainView.findViewById(R.id.freq_text);
        if (tv != null) {
            TextView tv_ps2 = (TextView) mMainView.findViewById(R.id.freq_text_ps2);
            if (mAkRadio.mStrRdsPs != null && mAkRadio.mStrRdsPs.length() > 0) {
    ...
    private void updateRdsInfo() {
        ...
        if (MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())) {
            int colorNormal = mContext.getResources().getColor(R.color.radio_tag_normal);
            int colorSelect = mContext.getResources().getColor(R.color.radio_tag_select);
            ...
            if (v instanceof ToggleButton) {
                ...
                af = (ToggleButton) mMainView.findViewById(R.id.radio_function_button_ta);
                if (af != null) {
                    if ((mAkRadio.mMRDRdsFlag & 0x20) != 0) {
                        af.setChecked(true);
                    } else {
    ...
    private void updatePtyInfo() {
        String name = "";
        if (mAkRadio.mMRDRdsPty[1] > 0 && mAkRadio.mMRDRdsPty[1] < PTYListViewAdapter.mPty_data.length) {
    ...
    private void doUpdateFreqency() {
        try {
            ...
            if (mAkRadio.mMRDBand < AkRadio.MRD_AM) {
                ...
                setViewVisible(mMainView, R.id.radio_function_button_st, View.VISIBLE);

                SetFmFreqTextImage(mAkRadio.mMRDFreqency);
                if (mMarkFace != null) {
                    mMarkFace.setmIsAM(false);
                    mMarkFace.setFmFrequencyRange(mAkRadio.mFreqMin, mAkRadio.mFreqMax);
                }
                ...
                if (MachineConfig.VALUE_SYSTEM_UI45_8702_2.equals(GlobalDef.getSystemUI())) {
                    ...
                    setViewVisible(mMainView, R.id.radio_function_button_st, View.GONE);
                } else {

                    setViewVisible(mMainView, R.id.radio_button_loc, View.INVISIBLE);
                    setViewVisible(mMainView, R.id.radio_function_button_st, View.INVISIBLE);
                }

                SetAmFreqTextImage(mAkRadio.mMRDFreqency);
                if (mMarkFace != null) {
                    mMarkFace.setmIsAM(true);
                    mMarkFace.setAmFrequencyRange(mAkRadio.mFreqMin, mAkRadio.mFreqMax);
                }
                mTVBand.setText(mAkRadio.getCurBaundText());
                mTVUnit.setText("KHz");
            ...
            if (v instanceof ToggleButton) {
                ToggleButton loc = (ToggleButton) mMainView.findViewById(R.id.radio_button_loc);
                if (loc != null) {
                    if ((mAkRadio.mMRDFlag & AkRadio.MRD_INFO_FLAG_LOCDX) != 0) {
                        loc.setChecked(true);
                    } else {
            ...
            if (MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())) {
                ...
                if ((mAkRadio.mMRDFlag & 0x2) == 0 && (mAkRadio.mMRDBand < AkRadio.MRD_AM)) {
                    ((TextView) v).setTextColor(colorSelect);
                } else {
                    ((TextView) v).setTextColor(colorNormal);
                }
                ...
                if ((mAkRadio.mMRDFlag & AkRadio.MRD_INFO_FLAG_LOCDX) != 0 && (mAkRadio.mMRDBand < AkRadio.MRD_AM)) {
            ...
            if (v instanceof ToggleButton) {
                ...
                if (MachineConfig.VALUE_SYSTEM_UI21_RM12.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI45_8702_2.equals(GlobalDef.getSystemUI())) {
                    if (mAkRadio.mMRDBand < AkRadio.MRD_AM) {
                        if ((mAkRadio.mMRDFlag & 0x2) == 0) {
                            setViewVisible(mMainView, R.id.radio_st_tag, View.VISIBLE);
                        } else {
                ...
                } else if (!MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())) {
                    if (mAkRadio.mMRDBand < AkRadio.MRD_AM) {
                        v.setEnabled(true);
                        if ((mAkRadio.mMRDFlag & 0x2) == 0) {
                            ((ImageView) v).setImageResource(R.drawable.btn_on);
    ...
    private boolean isFreqsFixBaud() {// freq list not fix the baud.
        boolean ret = true;
        if (mAkRadio.mMRDFreqs[0] < mAkRadio.mFreqMin || mAkRadio.mMRDFreqs[0] > mAkRadio.mFreqMax) {
            ret = false;
        }
    ...
    private void updateList() {
        ...
        if (mAkRadio.mCurPlayIndex >= 0 && mAkRadio.mCurPlayIndex < AkRadio.MIN_FREQ_LIST) {
            ...
            if (mAkRadio.mMRDFreqs[mAkRadio.mCurPlayIndex] == mAkRadio.mMRDFreqency) {
                ...
                if (mListViewFreqs != null) {
                    if (((mListViewFreqs.getLastVisiblePosition()) < mAkRadio.mCurPlayIndex) || (mListViewFreqs.getFirstVisiblePosition() >= mAkRadio.mCurPlayIndex)) {
                    ...
                    if (mHorizontalScrollView != null) {
                        if (mFreqsAdapter.mLineNum == 0) {
                            ...
                            int end = ((mHorizontalScrollView.getScrollX() + len) % total) / columnWidth;
    ...
    private void getListVisibleNum() {
        ...
        if (MachineConfig.VALUE_SYSTEM_UI_KLD3_8702.equals(value) || MachineConfig.VALUE_SYSTEM_UI45_8702_2.equals(value) || MachineConfig.VALUE_SYSTEM_UI_KLD15_6413.equals(value) || MachineConfig.VALUE_SYSTEM_UI32_KLD8.equals(value) || MachineConfig.VALUE_SYSTEM_UI34_KLD9.equals(value) || MachineConfig.VALUE_SYSTEM_UI37_KLD10.equals(value)) {
    ...
    private void updateButtonChannel(int index) {
        ...
        if (index != -1) {
            if (mHorizontalScrollView == null) {
                mHorizontalScrollView = (HorizontalScrollView) mMainView.findViewById(R.id.radio_frequency_scrollview);
            }
    ...
    private void changeFreqListNum() {
        ...
        if (mGirdViewFreqs != null) {
            ...
            View v = mMainView.findViewById(R.id.radio_scrollview_content_width);
            if (v != null) {
                int w;

                View v2 = mMainView.findViewById(R.id.radio_am_hide_layout);
                if (mAkRadio.mMRDBand < AkRadio.MRD_AM) {
                    w = mContext.getResources().getInteger(R.integer.radio_grid_fm_widht);
                    v2.setVisibility(View.VISIBLE);
                } else {
                    w = mContext.getResources().getInteger(R.integer.radio_grid_am_widht);
    ...
    private void updateChannel00Text(int index) {
        ...
        if (mPreChannelSel == -1 || mPreChannelBaud != mAkRadio.mMRDBand) {
            ...
            if (mUpdateChannell != -1) {
                setChanne00Text(getPosChannel00(mUpdateChannell), index, mUpdateChannell);
                mUpdateChannell = -1;
            }
            View v;
    ...
    private void clearFocus(View v2) {
        if (MachineConfig.VALUE_SYSTEM_UI21_RM10_2.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI20_RM10_1.equals(GlobalDef.getSystemUI())) {
    ...
    private void setChanne00Text(int id, int index, int i) {
        ...
        if (v != null) {
            ...
            if (mAkRadio != null) {
                ...
                if (mAkRadio.mMRDBand < AkRadio.MRD_AM) {
                    String ps = mAkRadio.getFreqPS(freq);
                    if (MachineConfig.VALUE_SYSTEM_UI22_1050.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())) {
                        ps = null;
                    }
                    if (ps == null) {
                        String s = (freq / 100) + ".";
                        ...
                        if (MachineConfig.VALUE_SYSTEM_UI21_RM10_2.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI22_1050.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI35_KLD813_2.equals(GlobalDef.getSystemUI())) {
                    ...
                    String s = freq + " ";
                    if (MachineConfig.VALUE_SYSTEM_UI21_RM10_2.equals(GlobalDef.getSystemUI()) || MachineConfig.VALUE_SYSTEM_UI22_1050.equals(GlobalDef.getSystemUI())) {
    ...
    private static final int[] BUTTON_ON_FOCUS_CHANGE = new int[]{
            R.id.channel_00, R.id.channel_01, R.id.channel_02, R.id.channel_03, R.id.channel_04, R.id.channel_05, R.id.channel_06, R.id.channel_07, R.id.channel_08, R.id.channel_09, R.id.channel_10,
            R.id.channel_11, R.id.channel_12, R.id.channel_13, R.id.channel_14, R.id.channel_15, R.id.channel_16, R.id.channel_17, R.id.channel_18, R.id.channel_19, R.id.channel_20, R.id.channel_21,
            R.id.channel_22, R.id.channel_23, R.id.channel_24, R.id.channel_25, R.id.channel_26, R.id.channel_27, R.id.channel_28, R.id.channel_29,
    };
