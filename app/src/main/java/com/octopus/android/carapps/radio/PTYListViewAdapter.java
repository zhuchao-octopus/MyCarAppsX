...
public class PTYListViewAdapter extends BaseAdapter {
	...
	public static String[] mPty_data = { "NONE", "NEWS", "AFFAIRS", "INFO", "SPORTS", "EDUCATE", "DRAMA", "CULTURE", "SCIENCE", "VARIED",
			"POP M", "ROCK M", "EASY M", "LIGHT M", "CLASSICS", "OTHER M", "WEATHERE", "FINANCE", "CHILDREN", "SOCIAL", "RELIGION",
...
//		}
	...
	public void setSelectItem(int pos) {
		...
		if (mPos != pos) {
			...
			if (mPos != -1) {
				setTextColor(PTYTypeList.get(mPos), mContext.getResources()
