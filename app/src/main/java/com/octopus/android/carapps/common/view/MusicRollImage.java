...
public class MusicRollImage extends ImageView {
	...
	public MusicRollImage(Context context) {
		super(context);
		init();
	}

	public MusicRollImage(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public MusicRollImage(Context context, AttributeSet attrs, int defStyleAttr) {
