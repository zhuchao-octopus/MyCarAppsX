...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    public final static String ACTION_WIDGET_MUSIC = ACTION_WIDGET_KEY_PREX + "m=";
    public final static String ACTION_WIDGET_RADIO = ACTION_WIDGET_KEY_PREX + "r=";
    public final static String ACTION_WIDGET_BT_MUSIC = ACTION_WIDGET_KEY_PREX + "b=";
    public final static String ACTION_WIDGET_DVD = ACTION_WIDGET_KEY_PREX + "d=";
