...
public class Screen1SaverUI extends UIBase {
    ...
    public static Screen1SaverUI getInstanse(Context context, View view, int index) {
    ...
    public void onCreate() {
        ...
        mMainView.findViewById(R.id.screen_save_click).setOnLongClickListener(new OnLongClickListener() {
            @Override
        ...
        int value = MachineConfig.getPropertyIntReadOnly(MachineConfig.KEY_OBD_SHOW_IN_SCREEN1);
        if (value == 1) {
            mIsObdExist = true;
        }
